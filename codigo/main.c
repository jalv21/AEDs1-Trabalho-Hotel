...
Descrição: Este é o arquivo principal do código do projeto na linguagem C, ele é
responsável por exibir o menu e executar as funções da biblioteca criada para
...
int main() {
  ...
  while (escolha != 9 && escolha < 9 && escolha > 0) {
    ...
    case 3:
      ...
      break;
    case 4:
      cadEstadia(estFile, cliFile, quaFile);
      break;
    case 5:
      baixaEstadia(estFile, cliFile, quaFile);
      break;
    case 6:
      pesquisa(cliFile, funFile);
      break;
    case 7:
      buscaEstadia(estFile, quaFile, cliFile);
      break;
    case 8:
      calculaPts(estFile, cliFile);
      break;
    }
